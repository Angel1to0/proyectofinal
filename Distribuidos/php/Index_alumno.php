...
<body>
    ...
    <header>
        <div class="contenedor">
            ...
            <h2 class="LogoT">Alumno provisional
            </h2>
            <nav>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><a class = "neon" href="../CRUD/Actualizar.php?boleta=<?php echo $row['boleta'] ?>">Editar</a></th>
                            <th><a class = "neonE" href="../CRUD/Eliminar.php?boleta=<?php echo $row['boleta'] ?>">Modificar</a></th>
